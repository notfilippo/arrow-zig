...
//!
//! Views check storage type and required buffers once, then expose typed
//! accessors without taking ownership. Use `sliceOwned` or `cloneRetained` when
//! a retained `ArrayData` reference is needed.
